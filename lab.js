...
favoriteThings.car = "Lamborghini Huracan Performante";
...
harry = new Wizard("dude", 55, "abra-cadabra")
harry.castSpell()
...
class Phone {
  ...
  sell(){
    this.sold = true;
    console.log(`${this.brand} ${this.model} as been sold`)
  }
...
samsung = new Phone("Samsung", "Galaxy", 240, "black", 1000)
blackBerry = new Phone("BlackBerry", "Gen1", 10, "blue", 350)
apple = new Phone("Apple", "I-Phone 11", 120, "white", 1200)
...
myFirstVehicle = new Vehicle(5, "white", 200000);
...
myFirstMotorcycle = new Motorcycle(1,"black,", 12000, "yamaha", true)
...
const myFirstBoat = new Boat(6, "green", 500, "Green-Lantern", "Speed Boat", false)
